...
- Create Angular project with ng: `ng new courseplatform.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`courseplatform.client.esproj`).
